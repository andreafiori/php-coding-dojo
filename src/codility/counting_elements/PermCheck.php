...
class PermCheck
{
    ...
    public function solution($A)
    {
        ...
        $permutationSum = $this->calculatePermutationSum($A);
        $actualSum = $this->calculateActualSum($A);
     ...
     * @return float
     */
    public function calculatePermutationSum(array $A): float
    {
        $N = count($A);
     ...
     * @return float
     */
    public function calculateActualSum(array $A): float
    {
        $actualSum = (float) 0;
