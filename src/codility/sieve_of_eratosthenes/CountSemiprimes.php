...
namespace codility\sieve_of_eratosthenes;
...
class CountSemiprimes
{
    ...
    public function solution($N, $P, $Q)
    {
        ...
        $semiprimes = $this->getSemiprimes($N, $primes);
     ...
     * @return array Primes
     */
    public function getPrimes(int $N): array
    {
     ...
     */
    public function getSemiprimes(int $N, array $primes): array
    {
        // Semiprimes from 2 to $N
        $semiprimes = [];
