...
class PermMissingElem
{
    ...
    public function solution($A)
    {
        ...
        $sumIncludingMissingInteger = $this->calculateSumIncludingMissingInteger($A);
        $sumWithoutMissingInteger = $this->calculateSumWithoutMissingInteger($A);
     ...
     * @return float
     */
    public function calculateSumIncludingMissingInteger(array $A): float
    {
        $N = count($A) + 1;
     ...
     * @return float
     */
    public function calculateSumWithoutMissingInteger(array $A): float
    {
