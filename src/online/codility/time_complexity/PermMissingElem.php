...
namespace online\codility\time_complexity;
...
*/
class PermMissingElem implements CodilityInterface
{
    /**
    ...
    public static function solution($A)
    {
        ...
        $sumIncludingMissingInteger = self::calculateSumIncludingMissingInteger($A);
        $sumWithoutMissingInteger = self::calculateSumWithoutMissingInteger($A);
     ...
     * @return float
     */
    public static function calculateSumIncludingMissingInteger(array $A): float
    {
        $N = count($A) + 1;
     ...
     * @return float
     */
    public static function calculateSumWithoutMissingInteger(array $A): float
    {
