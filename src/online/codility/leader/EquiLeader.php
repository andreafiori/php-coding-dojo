...
namespace online\codility\leader;
...
class EquiLeader
{
    ...
    {
        $leaderAndNumberOfOccurrences = self::findLeaderAndNumberOfOccurrences($A);
     ...
     */
    public static function findLeaderAndNumberOfOccurrences(array $A)
    {
