...
namespace online\codility\counting_elements;
...
class PermissionCheck
{
     ...
     * @return float
     */
    public static function calculatePermutationSum(array $A): float
    {
        $N = count($A);
     ...
     * @return float
     */
    public static function calculateActualSum(array $A): float
    {
        $actualSum = (float) 0;
