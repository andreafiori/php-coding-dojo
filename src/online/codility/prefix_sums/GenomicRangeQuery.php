...
namespace online\codility\prefix_sums;
...
class GenomicRangeQuery
{
    ...
    public static function solution($S, $P, $Q)
    {
        ...
        $nucleotidesRepetitions = self::getNucleotidesRepetitions($S, $nucleotides);
     ...
     * @return array
     */
    public static function getNucleotidesRepetitions(string $S, array $nucleotides): array
    {
