...
namespace online\codility\sieve_of_eratosthenes;
...
class CountSemiprimes
{
    ...
    public static function solution($N, $P, $Q)
    {
        ...
        $semiprimes = self::getSemiprimes($N, $primes);
     ...
     * @return array Primes
     */
    public static function getPrimes(int $N): array
    {
     ...
     */
    public static function getSemiprimes(int $N, array $primes): array
    {
        // Semiprimes from 2 to $N
        $semiprimes = [];
