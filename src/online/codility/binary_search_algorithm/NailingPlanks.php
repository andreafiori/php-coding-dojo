...
namespace online\codility\binary_search_algorithm;
...
class NailingPlanks
{
     ...
     * Task score:	100%
     */
    public static function solution($A, $B, $C)
    {
        ...
        while ($beg <= $end) {
            ...
            $areAllPlanksNailed = self::areAllPlanksNailed($planks, $availableNails);
     ...
     */
    public static function areAllPlanksNailed($planks, $availableNails)
    {
