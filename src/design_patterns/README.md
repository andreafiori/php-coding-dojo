...
- **Overriding** Replacing a method that would otherwise be inherited from a superclass with a new method defined in the subclass is called overriding the method.
